...
<body>
		...
		<div class="login">
			<form id="loginForm" action="${pageContext.request.contextPath}/cmfz/login" method="post" >
				...
				<table>
					<tbody>
						<tr>
							...
							<td>
								<input type="text"  name="name" class="text" value="admin" maxlength="20"/>
							</td>
					  </tr>
					  <tr>
							<th>
							...
							<td>
								<input type="password" name="password" class="text" value="admin" maxlength="20" autocomplete="off"/>
							</td>
					  </tr>
						...
						<tr>
							...
							<td>
								...
								<a href="${pageContext.request.contextPath}/cmfz/login"><img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/code" title="点击更换验证码"/></a>
							</td>
						</tr>					
					<tr>
						<td>
